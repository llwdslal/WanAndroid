...
@Singleton
class WendaDataSource @Inject constructor(
    private val wanAndroidService: WanAndroidService
){
    fun newPagingSource():PagingSource<Int,Article> = DataSource(wanAndroidService)
}
  ...
  private val wanAndroidService: WanAndroidService
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
            return try {
                  ...
                  val response = wanAndroidService.getWenda(pageNum,params.loadSize)//网络接口获取分页数据
